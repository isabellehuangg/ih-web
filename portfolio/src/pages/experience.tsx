...
export default function Experiences() {
    return (
        ...
        <h1 className="text-4xl font-bold mt-8 mb-6"><span className="gradient-text">Experience</span></h1>
          ...
          <Link href="https://drive.google.com/file/d/1wC8uzaD7gPID-yDb1nLe8QDnrYD8Inme/view" className="text-center text-beige p-2 sm:w-7/12 w-10/12 mb-4 gradient-button hover:bg-beige font-semibold border-0.5 border-beige rounded">View Resume</Link>
